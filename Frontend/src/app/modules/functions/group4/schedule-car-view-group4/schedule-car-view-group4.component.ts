...
@Component({
    selector: 'app-schedule-car-view-group4',
    templateUrl: './schedule-car-view-group4.component.html',
    styleUrls: ['./schedule-car-view-group4.component.less', '../../style.less'],
    animations: [appModuleAnimation()]
})
export class ScheduleCarViewGroup4Component extends AppComponentBase implements OnInit, AfterViewInit {
    /* *
        *
    ***/
