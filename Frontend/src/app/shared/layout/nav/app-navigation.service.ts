  ...
  getMenu(): AppMenu {
    return new AppMenu("MainMenu", "MainMenu", [
      ...
      new AppMenuItem(
        ...
        "Pages.Group0.Car",
        "flaticon-suitcase",
        "/app/admin/material-car-delete"
      ),
      new AppMenuItem(
        "SuggestCarManagement",
        "Pages.Group0.Car",
        "flaticon-plus",
        "/app/admin/dx-cars"
      ),
      ...
      new AppMenuItem(
        "MaintenanceNotificationManagement",
        "Pages.Group0.Car",
        "flaticon-list-1",
        "/app/admin/maintenance-car"
      ),
      new AppMenuItem(
      ...
      new AppMenuItem(
        "CarRentalProposingManagement",
        "Pages.Group0.Car",
        "flaticon-lifebuoy",
        "/app/admin/suggest-rent-car"
      ),
      new AppMenuItem(
        "RentalUnitsManagement",
        "Pages.Group0.Car",
        "flaticon-clipboard",
        "/app/admin/rent"
      ),
      new AppMenuItem(
        "VerificationAndRoadFees",
        "Pages.Group0.Car",
        "flaticon-piggy-bank",
