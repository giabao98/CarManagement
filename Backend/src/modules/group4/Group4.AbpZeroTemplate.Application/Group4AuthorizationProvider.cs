...
namespace Group4.AbpZeroTemplate.Application
{
  public class Group4AuthorizationProvider : AuthorizationProvider
  {
    ...
    group4TuyenChay.CreateChildPermission(Group4PermissionsConst.Pages_Administration_Group4TuyenChay_SearchById, L("Xem Chi Tiết"));
    group4TuyenChay.CreateChildPermission(Group4PermissionsConst.Pages_Administration_Group4TuyenChay_Update, L("Cập nhật"));
    group4TuyenChay.CreateChildPermission(Group4PermissionsConst.Pages_Administration_Group4TuyenChay_Delete, L("Xóa"));
    group4TuyenChay.CreateChildPermission(Group4PermissionsConst.Pages_Administration_Group4TuyenChay_Approve, L("Duyệt"));
    group4TuyenChay.CreateChildPermission(Group4PermissionsConst.Pages_Administration_Group4TuyenChay_Reject, L("Từ chối"));
