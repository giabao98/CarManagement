...
namespace Group2.AbpZeroTemplate.Application.Controllers
{
    ...
    public class Group2ThanhLyController : AbpController
    {
        ...
        [HttpPost]
        public List<Group2SearchDto> THANHLY_Group2SearchXe([FromBody]Group2ThanhLySearchInputDto input)
        {
            return Group2ThanhLyAppService.THANHLY_Group2SearchXe(input);
        }
    }
}
