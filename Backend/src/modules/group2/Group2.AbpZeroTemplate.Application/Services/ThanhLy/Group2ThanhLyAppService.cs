...
namespace Group2.AbpZeroTemplate.Web.Core.Cars
{
    public interface IGroup2ThanhLyAppService : IApplicationService
    {
        ...
        List<Group2SearchDto> THANHLY_Group2SearchXe(Group2ThanhLySearchInputDto input);
    ...
    public class Group2ThanhLyAppService : BaseService, IGroup2ThanhLyAppService
    {
        ...
        public List<Group2SearchDto> THANHLY_Group2SearchXe(Group2ThanhLySearchInputDto input)
        {
            return procedureHelper.GetData<Group2SearchDto>("THANHLY_Group2SearchXe", input);
        }
    }
}
